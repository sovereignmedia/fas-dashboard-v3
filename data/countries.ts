...
export const countries: Country[] = [
  ...
  { name: 'Poland', code: 'PL', lat: 51.9194, lng: 19.1451, coalProduction: 112, marketPotential: '$95B', patentStatus: 'Granted', facilityPotential: 4, color: '#d4a852' },
  { name: 'Colombia', code: 'CO', lat: 4.5709, lng: -74.2973, coalProduction: 54, marketPotential: '$42B', patentStatus: 'Filed', facilityPotential: 3, color: '#c084fc' },
